...
function Hero() {
  return (
    <div id="hero" className="relative min-h-screen h-screen flex justify-center items-center lg:px-[12vw] md:px-[10wv] px-4 text-center ">
        <HeroShaderBackground />
        <div>
          <h1 className=" font-black lg:text-5xl md:text-3xl text-xl lg:px-20 md:px-20 px-4 lg:mb-4 md:mb-4 mb-2">
            We Don’t Just Build <GradientCursiveText>Brands.</GradientCursiveText> We Build  <GradientCursiveText>Growth</GradientCursiveText> Systems.
          </h1>
